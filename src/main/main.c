...
int main()
{
  ...
  for(;;)
  {
    ...
    posY = 216;
    rdpq_text_printf(NULL, FONT_BUILTIN_DEBUG_MONO, posX, posY, "Speed: %.4f", (double) currSpeed); posY += 10;
    rdpq_text_printf(NULL, FONT_BUILTIN_DEBUG_MONO, posX, posY, "Blend: %.4f", (double) animBlend); posY += 10;
